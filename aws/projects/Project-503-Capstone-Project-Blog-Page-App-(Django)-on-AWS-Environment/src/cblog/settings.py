...
DATABASES = {
    'default': {
        ...
        'NAME': 'capstone-db', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'capstone-db.chj3hakffuf9.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-s3bucket-onur' # please enter your s3 bucket name
